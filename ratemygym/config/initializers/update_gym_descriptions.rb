Rails.application.config.after_initialize do
    ...
    image_url: "/assets/images/anytimefitnessimage.jpg"
    )
  ...
  image_url: "/assets/images/planetfitnessimage.png"
  )
  ...
  supportive, women-only space that empowers its members to prioritize fitness comfortably and confidently.",
   image_url: "/assets/images/shesfitimage.png"
  )
  ...
  image_url: "/assets/images/club16image.png"
  )
  ...
  image_url: "/assets/images/goldsgymimage.jpg"
  )
