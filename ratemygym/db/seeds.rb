...
Gym.create(
  ...
  description: "Anytime Fitness offers 24/7 access to over 5,000 locations worldwide, with membership rates starting around $40 to $50 per month. 
...
Gym.create(
  name: "Planet Fitness", 
  description: "Planet Fitness is known for its affordability, with membership options starting as low as $10 per month for the basic membership and $22.99 per month for the Black Card membership, 
...
Gym.create(
  name: "She's Fit", 
  description: "Shes Fit is a private womens gym that offers a comfortable, safe environment for women at all stages of their fitness journey. The gym is equipped with over 80 cardio machines, 
...
Gym.create(
  name: "Club 16", 
  description: "Club 16 provides a welcoming and inclusive environment with membership rates starting around $20 bi-weekly. With over 110 pieces of cardio equipment, some with personal TV screens, 
...
Gym.create(
  name: "Gold's Gym", 
  description: "Golds Gym is a premier fitness destination, with membership options starting around $30 to $60 per month depending on location and amenities. Known for its expert trainers, Golds Gym 
